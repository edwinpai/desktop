...
describe('useErrorRecovery', () => {
  ...
  it('should stop after max retries', async () => {
    ...
    expect(toast.error).toHaveBeenCalledWith('Recovery failed', expect.any(Object));
  });
  ...
  it('should show toast notifications by default', async () => {
    ...
    expect(toast.info).toHaveBeenCalledWith('Connection lost', expect.any(Object));
...
describe('useConnectionRecovery', () => {
  ...
  it('should detect recoverable errors', async () => {
    ...
    const networkError = vi.fn().mockRejectedValue(new Error('Network timeout'));
