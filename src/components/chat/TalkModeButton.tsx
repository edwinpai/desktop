...
export function TalkModeButton({ phase, error, onToggle, onCancel }: TalkModeButtonProps) {
...
function phaseTitle(phase: TalkPhase): string {
  switch (phase) {
    case 'idle': return 'Click to talk';
    case 'listening': return 'Click to send recording';
