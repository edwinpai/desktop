...
describe('AccessControlPanel', () => {
  ...
  it('renders empty state when no users', () => {
    ...
    expect(screen.getByText('Create an invitation to add users')).toBeInTheDocument();
  });
  ...
  it('renders multiple users', () => {
    ...
    render(
      <AccessControlPanel users={users} currentUserLevel="owner" />
    );
  ...
  it('shows correct capability indicators for owner', () => {
    render(
      <AccessControlPanel users={[mockOwner]} currentUserLevel="owner" />
    );
  ...
  it('shows correct capability indicators for guest', () => {
    render(
      <AccessControlPanel users={[mockGuest]} currentUserLevel="owner" />
    );
  ...
  it('formats days ago correctly', () => {
    ...
    render(
      <AccessControlPanel users={[oldUser]} currentUserLevel="owner" />
    );
  ...
  it('shows confirmation dialog before removing user', async () => {
    ...
    expect(mockConfirm).toHaveBeenCalledWith('Are you sure you want to remove this user?');
  });
