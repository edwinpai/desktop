...
describe('MatrixWizard', () => {
  ...
  describe('Intro Step', () => {
    it('should render intro step', () => {
      render(<MatrixWizard onComplete={mockOnComplete} onCancel={mockOnCancel} />);

      expect(screen.getByText('Connect Matrix Account')).toBeInTheDocument();
      expect(screen.getByText(/This wizard will help you connect to a Matrix homeserver/i)).toBeInTheDocument();
    });
  });
  ...
  describe('Credentials Step', () => {
    it('should render access token tab', async () => {
      ...
      expect(screen.getByRole('tab', { name: 'Access Token' })).toBeInTheDocument();
      expect(screen.getByPlaceholderText(/https:\/\/matrix\.org/i)).toBeInTheDocument();
    ...
    it('should render username/password tab', async () => {
      ...
      expect(screen.getByPlaceholderText(/@user:matrix\.org/i)).toBeInTheDocument();
    ...
    it('should validate homeserver URL format', async () => {
      ...
      const homeserverInput = screen.getByPlaceholderText(/https:\/\/matrix\.org/i);
  ...
  describe('Validation Step', () => {
    it('should call validateCredentials with correct data (token)', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/Validating your credentials/i)).toBeInTheDocument();
      });
    ...
    it('should call validateCredentials with correct data (password)', async () => {
      ...
      mockValidateCredentials.mockResolvedValue({
        valid: true,
        metadata: { homeserver: 'https://matrix.org', authMethod: 'password', username: '@alice:matrix.org' },
      });
