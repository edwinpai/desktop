...
const CHANNEL_FIELDS: Record<string, FieldDef[]> = {
  telegram: [
    ...
    {
      key: "allowFrom",
      label: "Allow From (comma-separated)",
      type: "text",
      section: "access",
    },
    {
      key: "groupAllowFrom",
      label: "Group Allow From (comma-separated)",
      type: "text",
      section: "access",
    },
    // Messaging
    ...
    {
      key: "actions.sendMessage",
      label: "Send Message",
      type: "switch",
      section: "actions",
    },
    {
      key: "actions.deleteMessage",
      label: "Delete Message",
      type: "switch",
      section: "actions",
    },
    {
      key: "actions.editMessage",
      label: "Edit Message",
      type: "switch",
      section: "actions",
    },
  ...
  discord: [
    ...
    {
      key: "actions.memberInfo",
      label: "Member Info",
      type: "switch",
      section: "actions",
    },
    {
      key: "actions.channelInfo",
      label: "Channel Info",
      type: "switch",
      section: "actions",
    },
    {
      key: "actions.moderation",
      label: "Moderation",
      type: "switch",
      section: "actions",
    },
...
export function ChannelConfigEditor({
  ...
  const handleSave = async () => {
        ...
        if (field.type === "number") {
          setNestedPatch(
            ...
            typeof newVal === "number"
              ? newVal
              : parseInt(String(newVal), 10) || 0,
          );
        } else if (
          field.key === "allowFrom" ||
          field.key === "groupAllowFrom"
        ) {
    ...
    try {
      ...
      setStatus({
        type: "success",
        message: `Saved to ${gatewayLabel}. Gateway reloading.`,
      });
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold">
            {CHANNEL_LABELS[channel] || channel} Settings
          </h3>
        </div>
        <div className="flex items-center gap-2">
          <Button
                  ...
                  <div className="px-4 py-3 space-y-4 border-t">
                    {sectionFields.map((field) => (
                      <FieldEditor
                        ...
                        onChange={(val) =>
                          setConfig((prev) =>
                            setNestedValue(prev, field.key, val),
                          )
                        }
                      />
                    ))}
