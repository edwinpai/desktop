...
export function DiscordWizard({ channel = 'discord', onComplete, onCancel, existingConfig }: ChannelWizardProps) {
          ...
          <TabsContent value="bot" className="space-y-4 mt-4">
            ...
            <div className="bg-orange-50 dark:bg-orange-950 p-3 rounded-lg">
              <p className="text-xs text-orange-900 dark:text-orange-100">
                <AlertTriangle className="h-4 w-4 inline text-amber-500 mr-1" /> Never share your bot token! It provides full access to your bot.
              </p>
            </div>
          </TabsContent>
            ...
            {validationMetadata.username && (
              <div className="text-sm text-muted-foreground">
                ...
                <span className="font-medium">
                  {validationMetadata.username}
                  {validationMetadata.discriminator && `#${validationMetadata.discriminator}`}
                </span>
              </div>
            )}
  ...
  const confirmationStep: WizardStepConfig = {
    ...
    content: (
      <div className="space-y-4">
        <div className="flex items-center gap-2 text-green-600 dark:text-green-400">
          ...
          <span className="font-medium">Discord bot configured successfully</span>
        </div>
    ...
    onValidate: async () => {
      ...
      try {
        ...
        onComplete?.({ enabled, botToken } as unknown as import("@/types/channels").ChannelConfig)
        return true
      } catch (err) {
