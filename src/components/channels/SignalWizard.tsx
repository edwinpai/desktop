...
export function SignalWizard({
  ...
  const [deviceData, setDeviceData] = useState(
    existingConfig?.credentials?.deviceData || "",
  );
    ...
    content: (
      <div className="space-y-4">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
          <li>
            A Signal account (can be your existing one or a dedicated bot
            number)
          </li>
        ...
        <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg space-y-3">
          ...
          <div className="space-y-3 text-sm text-blue-800 dark:text-blue-200">
            ...
            <div>
              ...
              <p className="text-xs mt-1 opacity-80">
                Scan the QR code with Signal on your phone → Settings → Linked
                Devices
              </p>
            </div>
            <div>
              ...
              <p className="text-xs mt-1 opacity-80">
                Look for a file named with your phone number (e.g., "235102" or
                "+1...")
              </p>
            </div>
            <div>
              <p className="font-medium">
                4. Copy the contents of that file and paste in the next step
              </p>
            </div>
          </div>
        </div>
        <div className="bg-green-50 dark:bg-green-950 p-4 rounded-lg">
          <p className="text-sm font-medium text-green-900 dark:text-green-100">
            <Lock className="h-4 w-4 inline mr-1" /> Device data is encrypted at
            rest using BRC-42 key derivation.
          </p>
        </div>
      </div>
    ),
      ...
      <div className="space-y-4">
              ...
              if (file) {
                ...
                reader.onload = (event) => {
                  try {
                    ...
                    setError(
                      "Invalid JSON file. Please upload a valid Signal device data file.",
                    );
                  }
                };
        ...
        <div className="bg-orange-50 dark:bg-orange-950 p-3 rounded-lg">
          <p className="text-xs text-orange-900 dark:text-orange-100">
            ...
            Keep your device data secure! It contains encryption keys for your
            Signal account.
          </p>
        </div>
      </div>
    ...
    onValidate: async () => {
      ...
      try {
        ...
        if (!parsed.deviceId && !parsed.number) {
          setError(
            "Invalid device data structure. Missing required fields (deviceId, number).",
          );
          return false;
        }
      } catch {
          ...
          <div className="space-y-3">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <span className="font-medium">
                {validationMetadata.status || "Linked"}
              </span>
            </div>
          </div>
        ) : (
    ...
    content: (
      <div className="space-y-4">
        <div className="flex items-center gap-2 text-green-600 dark:text-green-400">
          ...
          <span className="font-medium">
            Signal channel configured successfully
          </span>
        </div>
        ...
        <p className="text-sm text-muted-foreground">
          You can now receive and respond to Signal messages through EdwinPAI
